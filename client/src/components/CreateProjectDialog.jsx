...
const CreateProjectDialog = ({ isDialogOpen, setIsDialogOpen }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-zinc-900 dracula:bg-[#282a36] border border-zinc-200 dark:border-zinc-800 dracula:border-[#44475a] rounded-xl p-6 w-full max-w-lg text-zinc-900 dark:text-zinc-200 dracula:text-[#f8f8f2] relative max-h-[90vh] overflow-y-auto mx-4 my-8 dialog-scroll"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded dark:bg-zinc-800 dracula:bg-[#44475a] border border-zinc-300 dark:border-zinc-700 mt-1 text-zinc-900 dark:text-zinc-200 text-sm focus:border-blue-500 dracula:focus:border-[#bd93f9] focus:outline-none"
              required
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded dark:bg-zinc-800 dracula:bg-[#44475a] border border-zinc-300 dark:border-zinc-700 mt-1 text-zinc-900 dark:text-zinc-200 text-sm h-20 focus:border-blue-500 dracula:focus:border-[#bd93f9] focus:outline-none"
            />
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 pr-10 rounded dark:bg-zinc-800 dracula:bg-[#44475a] border border-zinc-300 dark:border-zinc-700 mt-1 text-zinc-900 dark:text-zinc-200 text-sm cursor-pointer focus:border-blue-500 dracula:focus:border-[#bd93f9] focus:outline-none"
                  style={{
          ...
          <div className="flex justify-end gap-3 pt-2 text-sm">
            ...
            <button
              ...
              className="px-4 py-2 rounded bg-gradient-to-br from-blue-500 to-blue-600 dracula:from-[#bd93f9] dracula:to-[#ff79c6] text-white hover:opacity-90 transition"
            >
