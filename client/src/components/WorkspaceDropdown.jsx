  ...
  return (
    <div className="relative m-4" ref={dropdownRef}>
      <button
        ...
        className="w-full flex items-center justify-between p-3 h-auto text-left rounded hover:bg-gray-100 dark:hover:bg-zinc-800 dracula:hover:bg-[#44475a]"
      >
      ...
      {isOpen && (
        <div className="absolute z-50 w-64 bg-white dark:bg-zinc-900 dracula:bg-[#282a36] border border-gray-200 dark:border-zinc-700 dracula:border-[#44475a] rounded shadow-lg top-full left-0">
          <div className="p-2">
            ...
            {userMemberships.data.map(({ organization }) => (
              <div
                ...
                className="flex items-center gap-3 p-2 cursor-pointer rounded hover:bg-gray-100 dark:hover:bg-zinc-800 dracula:hover:bg-[#44475a]"
              >
                <img
          ...
          <div
            ...
            className="p-2 cursor-pointer rounded group hover:bg-gray-100 dark:hover:bg-zinc-800 dracula:hover:bg-[#44475a]"
          >
