          ...
          >
            <div className="p-6 py-4">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm text-zinc-500 dark:text-zinc-400 dracula:text-[#6272a4] mb-1">
                    {title}
                  </p>
                  <p className="text-3xl font-bold text-zinc-800 dark:text-white dracula:text-[#f8f8f2]">
                    {value}
                  </p>
                  {subtitle && (
                    <p className="text-xs text-zinc-400 dark:text-zinc-500 dracula:text-[#6272a4] mt-1">
                      {subtitle}
                    </p>
                  )}
                </div>
